...
donde la suma es sobre los 6 vecinos más cercanos en la red cúbica.
"""
...
class Red:
    ...
    Cada nodo almacena un ángulo φ ∈ [0, 2π).
    ...
    def insertar_vortice(self, cx: int, cy: int,
        ...
        El perfil ansatz es:
            φ(r, θ) = N · arctan2(y, x) · tanh(r / (radio/2))
 
        tanh suaviza la singularidad en el origen.
        """
    ...
    def paso(self, dt: float = 0.1):
        ...
        La amortiguación γ > 0 garantiza convergencia.
        """
        f = self.fases
        laplaciano = (
    ...
    def snapshot(self) -> np.ndarray:
        """Copia del estado actual de fases."""
